...
from scapy.layers.zigbee import ZigbeeNWK, ZigBeeBeacon
...
class Network:
    def __init__(self):
        self.children = []
        self.parent_addr_src: typing.Optional[int] = None
        self.parent_addr_ext: typing.Optional[int] = None
    ...
    def get_packet_filtered(self, packet, pfilter):
        ...
        if pfilter == "all":
            ...
            # Thread/6LoWPAN is identified here as NOT having any Zigbee layers
            if not pkt.haslayer(ZigbeeNWK) and not pkt.haslayer(ZigBeeBeacon):
                return packet
        else:
