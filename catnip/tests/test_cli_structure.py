...
EXPECTED_PARAMS = {
    ...
    "catnip spam": [],
    "catnip spam modes": [],
    "catnip spam run": ["--baudrate", "--device", "--mode", "--yes", "-b", "-d", "-m", "-y"],
    "catnip spam start": ["--baudrate", "--device", "--mode", "--yes", "-b", "-d", "-m", "-y"],
    ...
    "catnip sniff profiles": ["--command", "-c"],
    "catnip sniff thread": [
        "--ascii",
        "--channel",
        "--device",
    ...
    "catnip status": ["--device", "--diagnostics", "-D", "-d"],
    "catnip update": ["--board", "--device", "--force", "-d", "-f"],
