...
curl -LO https://github.com/ElectronicCats/catsniffer-tools/releases/download/latest/catnip-3.3.3.0-x86_64.pkg

# Install the package
sudo installer -allowUntrusted -pkg catnip-3.3.3.0-x86_64.pkg -target /
```
...
curl -LO https://github.com/ElectronicCats/catsniffer-tools/releases/download/latest/catnip-3.3.3.0-arm64.pkg

# Install the package
sudo installer -allowUntrusted -pkg catnip-3.3.3.0-arm64.pkg -target /
```
...
wget https://github.com/ElectronicCats/catsniffer-tools/releases/download/latest/catnip-3.3.3.0.deb

# Install the package
sudo dpkg -i catnip-3.3.3.0.deb
...
wget https://github.com/ElectronicCats/catsniffer-tools/releases/download/latest/catnip-3.3.3.0.pkg.tar.zst

# Install the package
sudo pacman -U catnip-3.3.3.0.pkg.tar.zst
