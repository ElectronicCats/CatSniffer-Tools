...
class SnifferExtcapPlugin:
    ...
    def extcap_interfaces(self):
        ...
        # TODO: Fix the channel hopping feature in SnfferCollector
        # lines.append(
    ...
    def extcap_config(self):
        ...
        lines.append(
            "arg {number=1}{call=--channel}{type=selector}{default=11}"
    ...
    def capture(self):
        ...
        self.hw.set_protocol_channel(self.args.channel)
