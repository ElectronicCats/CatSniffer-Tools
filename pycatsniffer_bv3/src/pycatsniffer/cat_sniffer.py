...
from .Modules.SnifferCollector import SnifferCollector as SCollector
...
class Catsniffer:
    def __init__(self, sniffer_collector: SCollector):
    ...
    def start(
        ...
        comport: str = typer.Argument(
            default=SCollector().board_uart.find_catsniffer_serial_port(),
...
https://pwnlab.mx/\x1b[0m""",
        ...
        self.sniffer_collector = SCollector()
